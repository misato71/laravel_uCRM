                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div v-if="props.order[0].status == true" class="p-2 w-full">
                                  <Link as="button" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" :href="route('purchases.edit', { purchase: props.order[0].id })">編集する</Link>
                                </div>
